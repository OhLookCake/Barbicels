...
#initweights = [3.893786623207748, 3.1604925401920547, -0.17075724311551416, -1.6503502356193231, 2.0694882686437124, -0.58694612682381375, 1.4049071458396685]# start from gen 5
...
#        if os.path.isfile('outfile'+str(itercounter) + '_' + str(counter) +'.txt'):
#            print("File already exists. Retrieving.")
#            cmd = "sh fetchfitness.sh " + str(itercounter) + " " + str(counter)
        print("CMD: " +cmd)
#        else:
